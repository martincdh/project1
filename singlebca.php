...
<h2> Retrieves records based on BGSU email </h2>

<?php 

// Retrieves records by the input email

if (!empty($_POST['bgsuemail'])) {
...
if (empty($_POST['bgsuemail'])) {
 ...
 $query = "SELECT * FROM Gradsurvey WHERE bgsuemail = '$email'";	  	  
